...
protocol Flier2 {
    ...
    func flockTogetherWith(_ f:Self.Other)
...
do {
    ...
    do {
        //let w : Wrapper<Cat> = Wrapper<CalicoCat>() 
        // error: cannot convert value of type 'Wrapper<CalicoCat>' to specified type 'Wrapper<Cat>'
