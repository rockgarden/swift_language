...
/*:
 ...
 - If you create an instance of a structure and assign that instance to a constant, you cannot modify the instance’s properties实例属性, even if they were declared as variable properties.
...
do {
    class Dog {
        // final class method can't override
